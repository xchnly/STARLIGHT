    ...
    <div>
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="item in stats" :key="item.id"
                ...
                <dt>
                    <div class="absolute rounded-md bg-warna2 p-3">
                ...
                <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                    ...
                    <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
                        <div class="text-sm">
                            <a href="#" class="font-medium text-warna2 hover:text-warna2">View all<span class="sr-only">
        ...
        <MultiAxisChart :series-data="chartData" :categories="categories" />
        <ListProgress />
    </div>
</template>
...
import MultiAxisChart from './../components/Chart.vue'
import ListProgress from './../components/ListProgress.vue'
...
const categories = ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
const chartData = [
    [448, 540, 775, 600],  // Produk 1G0000319
    [58, 54, 169, 80],  // Produk 1G0000371
    [82, 93, 182, 169],  // Produk 1N0047
]
</script>